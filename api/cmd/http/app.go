...
import (
	...
	_ "github.com/IndominusByte/danspro-be/api/docs" // docs is generated by Swag CLI, you have to import it.
	"github.com/IndominusByte/danspro-be/api/internal/config"
	handler_http "github.com/IndominusByte/danspro-be/api/internal/endpoint/http/handler"
)
